    ...
    RUN: while(true){
      switch(S3047){
        ...
        case 1 : 
          ...
          int biggest3055 = 0;
          if(ends[2]>=biggest3055){
            biggest3055=ends[2];
          }
          if(ends[3]>=biggest3055){
            biggest3055=ends[3];
          }
          if(ends[4]>=biggest3055){
            biggest3055=ends[4];
          }
          if(ends[5]>=biggest3055){
            biggest3055=ends[5];
          }
          if(ends[6]>=biggest3055){
            biggest3055=ends[6];
          }
          if(ends[7]>=biggest3055){
            biggest3055=ends[7];
          }
          if(biggest3055 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          if(ends[4]>=biggest3062){
            biggest3062=ends[4];
          }
          if(ends[5]>=biggest3062){
            biggest3062=ends[5];
          }
          if(ends[6]>=biggest3062){
            biggest3062=ends[6];
          }
          if(ends[7]>=biggest3062){
            biggest3062=ends[7];
          }
          if(biggest3062 == 1){
            active[1]=1;
