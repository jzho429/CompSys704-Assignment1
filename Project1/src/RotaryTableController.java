...
public class RotaryTableController extends ClockDomain{
  ...
  private int currentCount_thread_2;//sysj\TopLevel\TopLevel.sysj line: 9, column: 9
  private int S203 = 1;
  private int S169 = 1;
  private int S27 = 1;
  private int S4 = 1;
  ...
  public void thread215(int [] tdone, int [] ends){
      ...
      case 1 : 
        if(fillAmount4E.getprestatus()){//sysj\TopLevel\TopLevel.sysj line: 30, column: 26
          fillAmount4.setPresent();//sysj\TopLevel\TopLevel.sysj line: 30, column: 40
          currsigs.addElement(fillAmount4);
          fillAmount4.setValue((Integer)(fillAmount4E.getpreval() == null ? 0 : ((Integer)fillAmount4E.getpreval()).intValue()));//sysj\TopLevel\TopLevel.sysj line: 30, column: 40
          active[6]=1;
          ends[6]=1;
          tdone[6]=1;
        }
  ...
  public void thread214(int [] tdone, int [] ends){
      ...
      case 1 : 
        if(fillAmount3E.getprestatus()){//sysj\TopLevel\TopLevel.sysj line: 28, column: 26
          fillAmount3.setPresent();//sysj\TopLevel\TopLevel.sysj line: 28, column: 40
          currsigs.addElement(fillAmount3);
          fillAmount3.setValue((Integer)(fillAmount3E.getpreval() == null ? 0 : ((Integer)fillAmount3E.getpreval()).intValue()));//sysj\TopLevel\TopLevel.sysj line: 28, column: 40
          active[5]=1;
          ends[5]=1;
          tdone[5]=1;
        }
  ...
  public void thread213(int [] tdone, int [] ends){
      ...
      case 1 : 
        if(fillAmount2E.getprestatus()){//sysj\TopLevel\TopLevel.sysj line: 26, column: 26
          fillAmount2.setPresent();//sysj\TopLevel\TopLevel.sysj line: 26, column: 40
          currsigs.addElement(fillAmount2);
          fillAmount2.setValue((Integer)(fillAmount2E.getpreval() == null ? 0 : ((Integer)fillAmount2E.getpreval()).intValue()));//sysj\TopLevel\TopLevel.sysj line: 26, column: 40
          active[4]=1;
          ends[4]=1;
          tdone[4]=1;
        }
  ...
  public void thread212(int [] tdone, int [] ends){
      ...
      case 1 : 
        if(fillAmount1E.getprestatus()){//sysj\TopLevel\TopLevel.sysj line: 24, column: 26
          fillAmount1.setPresent();//sysj\TopLevel\TopLevel.sysj line: 24, column: 40
          currsigs.addElement(fillAmount1);
          fillAmount1.setValue((Integer)(fillAmount1E.getpreval() == null ? 0 : ((Integer)fillAmount1E.getpreval()).intValue()));//sysj\TopLevel\TopLevel.sysj line: 24, column: 40
          active[3]=1;
          ends[3]=1;
          tdone[3]=1;
        }
  ...
  public void thread211(int [] tdone, int [] ends){
      ...
      case 1 : 
        switch(S27){
          case 0 : 
            if(start.getprestatus()){//sysj\TopLevel\TopLevel.sysj line: 11, column: 19
              S27=1;
              S4=0;
              active[2]=1;
              ends[2]=1;
          ...
          case 1 : 
            switch(S4){
              case 0 : 
                if(bottleLeftPos5.getprestatus()){//sysj\TopLevel\TopLevel.sysj line: 14, column: 27
                  S4=1;
                  if(currentCount_thread_2 > (Integer)(bottleCount.getpreval() == null ? 0 : ((Integer)bottleCount.getpreval()).intValue())){//sysj\TopLevel\TopLevel.sysj line: 15, column: 24
                    ends[2]=2;
                    ;//sysj\TopLevel\TopLevel.sysj line: 12, column: 13
                    S27=0;
                    active[2]=1;
                    ends[2]=1;
                    tdone[2]=1;
                    ...
                    bottleAtPos0.setPresent();//sysj\TopLevel\TopLevel.sysj line: 16, column: 21
                    currsigs.addElement(bottleAtPos0);
                    currentCount_thread_2 = currentCount_thread_2 + 1;//sysj\TopLevel\TopLevel.sysj line: 17, column: 21
                    S4=2;
                    active[2]=1;
                    ends[2]=1;
                    tdone[2]=1;
  ...
  public void thread205(int [] tdone, int [] ends){
        S169=1;
    currentCount_thread_2 = 0;//sysj\TopLevel\TopLevel.sysj line: 9, column: 9
    S27=0;
    active[2]=1;
    ends[2]=1;
    tdone[2]=1;
