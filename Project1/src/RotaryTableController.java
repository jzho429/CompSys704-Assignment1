...
public class RotaryTableController extends ClockDomain{
  ...
  public void thread1893(int [] tdone, int [] ends){
      ...
      case 1 : 
        if(com.systemj.Timer.getMs() - __start_thread_10 >= (1) * 1000){//sysj\RotaryTable\RotaryTableController.sysj line: 30, column: 37
          ends[10]=3;
  ...
  public void thread1884(int [] tdone, int [] ends){
      ...
      case 1 : 
        if(com.systemj.Timer.getMs() - __start_thread_8 >= (1) * 1000){//sysj\RotaryTable\RotaryTableController.sysj line: 24, column: 37
          ends[8]=3;
